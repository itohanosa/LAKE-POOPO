...
LS_17_18_ndvi_diff <- LS_2017_ndvi-LS_2018_ndvi
...
LS_2001_rf<- superClass(img = LS_2001, model="rf", nSamples = 1000, trainData = TD_2001, responseCol = "X2001", na.omit=TRUE, trainPartition = 0.7)
LS_2001_rf[LS_2001_rf=2]<-NA
head(LS_2001_rf)
LS_2001_rf
...
LS_2017_rf<- superClass(img = LS_2017, model="rf", nSamples = 1000, trainData = TD_2017, na.omit=TRUE, trainPartition = 0.7, responseCol = "classifica")
LS_2017_rf
...
#rf
LS_2018_rf<- superClass(img = LS_2018b, model="rf", nSamples = 1000, trainData = TD_2018, na.omit=TRUE, responseCol = "class2018")
LS_2018_rf
...
LS_Change1<- superClass(img = LS_01_18, model="rf", nSamples = 1000, trainData = TD1,trainPartition = 0.5, na.omit=TRUE, responseCol = "new_shp")
LS_Change1
...
library(RStoolbox)
library(e1071)
LS_Change1<- superClass(img = LS_01_18, model="svm", nSamples = 1000, trainData = TD1, na.omit=TRUE, responseCol = "new_shp")
LS_Change1
LS_Change1$classMapping
...
hist(LS_2017_rf$classMapping, main="", col="yellow",
     xlab="training")



#error matrix #accuracy assessment #LS_Change$validation$performance
#validation
#LS_Change
#uC_17 <- unique(LS_2017_rf)
#uC_17
